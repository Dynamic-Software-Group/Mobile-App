...
export default function App() {
    ...
    return (
        <ScrollView>
            ...
            <SafeAreaView>
                    <View>
                        <Text style={{left: wp('3%'), top: hp('2%'), fontFamily: "Montserrat_300Light", fontSize: wp('4.25%'), fontStyle: 'normal'}}>Explore Stores</Text>
                        <Text style={{left: wp('2.5%'), top: hp('1.75%'), fontFamily: "Montserrat_400Regular", fontWeight: 400, fontSize: wp('9%')}}>Near You</Text>
                        ...
                        <View style={{top: hp('13%')}}>
                            <View style={{}}>
                                ...
                                <Text style={{top: hp('-3%'), fontSize: wp('4%'), fontFamily: 'Montserrat_400Regular', textAlign: 'center'}}>You have no points yet. Start shopping to earn points!</Text>
                            </View>
                        </View>
                        {/* Stores section */}
                        <View style={{top: hp('15%')}}>
                            <Text style={{left: wp('4.5%'), fontSize: wp('5%'), fontFamily: 'Montserrat_700Bold'}}>Near You</Text>
                            <View style={{left: wp('3.5%'), top: hp('2%'), backgroundColor: '#eceaea', height: hp('16%'), width: wp('45%'), borderRadius: wp('5%')}}>
                                <Image source={require('./assets/one.png')} resizeMethod={'resize'} style={{resizeMode: 'center', left: wp('-16%'), top: hp('-4%')}}></Image>
                                <Text style={{top: hp('50%')}}>hi</Text>
                            </View>
                        </View>
